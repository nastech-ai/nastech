...
- comparisons back to NasTech when the finding affects product or protocol design
...
existing adjacent area under `../nastech-adjacent/research/{vendor}` when it
...
Start with the protocol and control surfaces that matter most for NasTech:
