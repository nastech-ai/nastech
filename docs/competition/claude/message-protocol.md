...
- `../nastech-adjacent/research/agent-client-protocol/src/agent.rs`
- `../nastech-adjacent/research/agent-client-protocol/src/client.rs`
- `../nastech-adjacent/research/agent-client-protocol/src/tool_call.rs`
...
This is important for NasTech because it shows where clean protocol stops and provider-specific behavior begins.

Primary source files:

- `../nastech-adjacent/research/claude-code-acp/src/acp-agent.ts`
- `../nastech-adjacent/research/claude-code-acp/src/settings.ts`
...
- `../nastech-adjacent/research/claude-code/plugins/plugin-dev/skills/hook-development/SKILL.md`
- `../nastech-adjacent/research/claude-code/CHANGELOG.md`
...
The main lesson for NasTech is not to copy the hidden-file layout. The lesson is to
keep agent identity, team membership, and task lifecycle explicit.

Primary source files:

- `../nastech-adjacent/research/claude-code/plugins/plugin-dev/skills/agent-development/SKILL.md`
...
This is a strong pattern for NasTech: mode and permission state should be first-class and inspectable.

Primary source files:

- `../nastech-adjacent/research/claude-code/examples/settings/settings-strict.json`
- `../nastech-adjacent/research/claude-code/plugins/plugin-dev/skills/hook-development/SKILL.md`
- `../nastech-adjacent/research/claude-code/CHANGELOG.md`
...
- `../nastech-adjacent/research/claude-code/examples/settings/README.md`
- `../nastech-adjacent/research/claude-code/examples/settings/settings-bash-sandbox.json`
- `../nastech-adjacent/research/claude-code/CHANGELOG.md`
...
This is a reminder for NasTech that resume correctness is not a small detail; it is a protocol feature.
...
So Claude is useful as a workflow reference, but not the best single source for NasTech's own sync protocol.

## What NasTech should steal
