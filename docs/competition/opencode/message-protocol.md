...
If NasTech wants a strong protocol reference for app + server + session UI, this is
...
This is a very good pattern for NasTech: use events for freshness, not as the only
source of truth.
...
This is much closer to what NasTech should want than flattening delegated work into
one chat thread without identity.

Primary source files:

- `../nastech-adjacent/research/opencode/packages/opencode/src/tool/task.ts`
- `../nastech-adjacent/research/opencode/packages/opencode/src/agent/agent.ts`
...
This is a strong design signal for NasTech: todos should be their own state channel.

Primary source files:

- `../nastech-adjacent/research/opencode/packages/opencode/src/tool/todo.ts`
- `../nastech-adjacent/research/opencode/packages/opencode/src/session/todo.ts`
...
This is a good reference for NasTech's app model even if NasTech keeps its own policy
engine.
...
- `../nastech-adjacent/research/opencode/packages/app/src/context/permission.tsx`
...
Takeaway for NasTech: copy the workspace isolation ideas, not the lack of a deeper
sandbox layer.

Primary source files:

- `../nastech-adjacent/research/opencode/packages/opencode/src/worktree/index.ts`
- `../nastech-adjacent/research/opencode/packages/opencode/src/control-plane/workspace.ts`
...
This is a much better direction for NasTech than a single opaque message pipeline.
...
- `../nastech-adjacent/research/opencode/packages/app/src/context/sync.tsx`
