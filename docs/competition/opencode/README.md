...
Reviewed on 2026-03-21 from `../nastech-adjacent/research/opencode` at commit
`2e0d5d230893dbddcefb35a02f53ff2e7a58e5d0`.

## Why it matters

OpenCode is currently the strongest overall product reference for NasTech.
...
- the transcript and sync model look much closer to what NasTech should want than a flat custom message stream
