...
- nastech-wire.md: Shared wire schemas/types package and migration notes.
...
## Conventions
- Paths and field names reflect the current implementation in `packages/nastech-server`.
