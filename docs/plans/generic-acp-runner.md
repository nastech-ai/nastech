...
- **Session protocol types** in `@nastech-ai/nastech-wire` (`SessionEnvelope`, `createEnvelope()`).
...
**File**: `packages/nastech-cli/src/agent/acp/AcpSessionMapper.ts`
...
**Test file**: `packages/nastech-cli/src/agent/acp/AcpSessionMapper.test.ts`
...
**File**: `packages/nastech-cli/src/agent/acp/runAcp.ts`
