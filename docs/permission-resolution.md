...
- Mapping to Claude happens in `packages/nastech-cli/src/claude/utils/permissionMode.ts`:
...
`packages/nastech-app/sources/sync/storage.ts`
...
`packages/nastech-app/sources/app/(app)/new/index.tsx`
`packages/nastech-app/sources/components/NewSessionWizard.tsx`
...
`packages/nastech-app/sources/sync/sync.ts`
...
`packages/nastech-cli/src/claude/runClaude.ts`
`packages/nastech-cli/src/claude/utils/permissionMode.ts`
...
`packages/nastech-cli/src/claude/claudeLocal.ts`
