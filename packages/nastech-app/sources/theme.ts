...
export const lightTheme = {
    ...
    colors: {
        ...
        switch: {
            track: { active: Platform.select({ ios: '#34C759', default: '#1976D2' }), inactive: '#dddddd' },
        ...
        status: {
            connected: '#34C759', connecting: '#007AFF',
            disconnected: '#999999', error: '#FF3B30', default: '#8E8E93',
        },
        permission: {
            default: '#8E8E93', acceptEdits: '#007AFF', bypass: '#FF9500',
            plan: '#34C759', readOnly: '#8B8B8D', safeYolo: '#FF6B35', yolo: '#DC143C',
        },
        permissionButton: {
...
export const darkTheme = {
    ...
    colors: {
        ...
        switch: {
            track: { active: Platform.select({ ios: '#34C759', default: '#1976D2' }), inactive: '#3a393f' },
            thumb: { active: '#FFFFFF', inactive: '#767577' },
        },
        ...
        status: {
            connected: '#34C759', connecting: '#FFFFFF',
            disconnected: '#8E8E93', error: '#FF453A', default: '#8E8E93',
        },
        permission: {
            default: '#8E8E93', acceptEdits: '#0A84FF', bypass: '#FF9F0A',
            plan: '#32D74B', readOnly: '#98989D', safeYolo: '#FF7A4C', yolo: '#FF453A',
        },
        permissionButton: {
        ...
        diff: {
            outline: '#30363D', success: '#3FB950', error: '#F85149',
...
// AMOLED: pure #000000 background, maximum contrast, saves battery on OLED screens
export const amoledTheme = {
    ...
    colors: {
        ...
        surfacePressedOverlay: '#111111',
        surfaceHigh: '#0A0A0A',
        surfaceHighest: '#141414',
        divider: '#1C1C1C',
        shadow: {
            color: '#000000',
            opacity: 0.3,
        ...
        switch: {
            track: { active: '#34C759', inactive: '#2A2A2A' },
            thumb: { active: '#FFFFFF', inactive: '#767577' },
        },
        fab: { background: '#FFFFFF', backgroundPressed: '#E5E5E5', icon: '#000000' },
        radio: { active: '#0A84FF', inactive: '#3A3A3C', dot: '#0A84FF' },
        modal: { border: 'rgba(255, 255, 255, 0.08)' },
        button: {
            primary: { background: '#FFFFFF', tint: '#000000', disabled: '#333333' },
            secondary: { tint: '#8E8E93' },
        },
        input: { background: '#0D0D0D', text: '#FFFFFF', placeholder: '#8E8E93' },
        box: {
            warning: { background: 'rgba(255, 159, 10, 0.12)', border: '#FF9F0A', text: '#FFAB00' },
            error: { background: 'rgba(255, 69, 58, 0.12)', border: '#FF453A', text: '#FF6B6B' },
        },
        status: {
            connected: '#32D74B', connecting: '#FFFFFF',
            disconnected: '#636366', error: '#FF453A', default: '#636366',
        },
        permission: {
            default: '#636366', acceptEdits: '#0A84FF', bypass: '#FF9F0A',
            plan: '#32D74B', readOnly: '#636366', safeYolo: '#FF7A4C', yolo: '#FF453A',
        },
        permissionButton: {
            allow: { background: '#32D74B', text: '#000000' },
            deny: { background: '#FF453A', text: '#FFFFFF' },
            allowAll: { background: '#0A84FF', text: '#FFFFFF' },
            inactive: { background: '#111111', border: '#1C1C1C', text: '#636366' },
            selected: { background: '#0D0D0D', border: '#1C1C1C', text: '#FFFFFF' },
        },
        diff: {
            outline: '#1C1C1C', success: '#32D74B', error: '#FF453A',
            addedBg: '#001A0D', addedBorder: '#32D74B', addedText: '#E5E5E5',
            removedBg: '#1A0005', removedBorder: '#FF453A', removedText: '#E5E5E5',
            contextBg: '#080808', contextText: '#636366',
            lineNumberBg: '#080808', lineNumberText: '#3A3A3C',
            hunkHeaderBg: '#080808', hunkHeaderText: '#0A84FF',
            leadingSpaceDot: '#1C1C1C',
            inlineAddedBg: '#003318', inlineAddedText: '#5AFF7A',
            inlineRemovedBg: '#330008', inlineRemovedText: '#FF7A7A',
        },
        userMessageBackground: '#0D0D0D',
        userMessageText: '#FFFFFF',
        agentMessageText: '#FFFFFF',
        agentEventText: '#636366',
        syntaxKeyword: '#569CD6', syntaxString: '#CE9178', syntaxComment: '#6A9955',
        syntaxNumber: '#B5CEA8', syntaxFunction: '#DCDCAA',
        syntaxBracket1: '#FFD700', syntaxBracket2: '#DA70D6', syntaxBracket3: '#179FFF',
        syntaxBracket4: '#FF8C00', syntaxBracket5: '#00FF00', syntaxDefault: '#D4D4D4',
        gitBranchText: '#636366', gitFileCountText: '#636366',
        gitAddedText: '#32D74B', gitRemovedText: '#FF453A',
        terminal: {
            background: '#000000', prompt: '#32D74B', command: '#E0E0E0',
            stdout: '#E0E0E0', stderr: '#FFB86C', error: '#FF6B6B', emptyOutput: '#636366',
        },
    },
    ...sharedSpacing,
} satisfies typeof lightTheme;
