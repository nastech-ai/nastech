...
describe('buildResumeCommand', () => {
    it('builds a Claude resume command that enters the session directory first', () => {
        ...
        })).toBe(`cd '/tmp/project' && nastech claude --resume 93a9705e-bc6a-406d-8dce-8acc014dedbd`);
    });
    ...
    it('builds a Windows Codex resume command using PowerShell directory navigation', () => {
        ...
        })).toBe(`Set-Location -LiteralPath 'C:\\Users\\test\\project'; nastech codex --resume 019ccca5-726b-7c61-b914-16de27dfab6e`);
    });
