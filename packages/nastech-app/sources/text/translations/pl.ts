...
export const pl: TranslationStructure = {
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Osiągnąłeś maksymalną liczbę rozmów głosowych w tym miesiącu. Możliwe, że w przyszłości dodamy głosowe korzystanie na żądanie — prosimy o zgłoszenie na github.com/nicepkg/nastech/issues, jeśli napotkasz ten limit.',
    ...
    server: {
        ...
        notValidHappyServer: 'To nie jest prawidłowy serwer NasTech',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID sesji NasTech skopiowane do schowka',
        failedToCopySessionId: 'Nie udało się skopiować ID sesji NasTech',
        happySessionId: 'ID sesji NasTech',
        ...
        happyHome: 'Katalog domowy NasTech',
        ...
        updateCliInstructions: 'Proszę uruchomić npm install -g nastech@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Zainstaluj NasTech CLI',
            runIt: 'Uruchom je',
