...
export const ca: TranslationStructure = {
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Has assolit el nombre màxim de converses de veu aquest mes. És possible que en el futur afegim ús de veu sota demanda — si us plau, crea un issue a github.com/nicepkg/nastech/issues si arribes a aquest límit.',
    ...
    server: {
        ...
        notValidHappyServer: 'No és un servidor NasTech vàlid',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de la sessió de NasTech copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió de NasTech',
        happySessionId: 'ID de la sessió de NasTech',
        ...
        happyHome: 'Directori de NasTech',
        ...
        updateCliInstructions: 'Si us plau executeu npm install -g nastech@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instal·la el NasTech CLI',
            runIt: 'Executa\'l',
