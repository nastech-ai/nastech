...
export const ja: TranslationStructure = {
    ...
    errors: {
        ...
        voiceConversationLimitReached: '今月の音声会話の最大数に達しました。将来的にオンデマンドの音声利用を追加する可能性があります。この制限に達した場合は、github.com/nicepkg/nastech/issues で issue を作成してください。',
    ...
    server: {
        ...
        notValidHappyServer: '有効なNasTech Serverではありません',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'NasTech Session IDがクリップボードにコピーされました',
        ...
        updateCliInstructions: 'npm install -g nastech@latest を実行してください',
