...
export const it: TranslationStructure = {
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Hai raggiunto il numero massimo di conversazioni vocali questo mese. Potremmo aggiungere l\'uso vocale su richiesta in futuro — per favore apri un issue su github.com/nicepkg/nastech/issues se raggiungi questo limite.',
    ...
    server: {
        ...
        notValidHappyServer: 'Non è un NasTech Server valido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID sessione NasTech copiato negli appunti',
        failedToCopySessionId: 'Impossibile copiare l\'ID sessione NasTech',
        happySessionId: 'ID sessione NasTech',
        ...
        updateCliInstructions: 'Esegui npm install -g nastech@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Installa la CLI NasTech',
            runIt: 'Avviala',
