...
export const en: TranslationStructure = {
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'You\'ve reached the maximum number of voice conversations this month. We may add on-demand voice usage in the future — please file an issue at github.com/nicepkg/nastech/issues if you hit this limit.',
    ...
    server: {
        ...
        notValidHappyServer: 'Not a valid NasTech Server',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'NasTech Session ID copied to clipboard',
        failedToCopySessionId: 'Failed to copy NasTech Session ID',
        happySessionId: 'NasTech Session ID',
        ...
        updateCliInstructions: 'Please run npm install -g nastech@latest',
