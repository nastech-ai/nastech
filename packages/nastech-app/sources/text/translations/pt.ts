...
export const pt: TranslationStructure = {
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Você atingiu o número máximo de conversas de voz este mês. Podemos adicionar uso de voz sob demanda no futuro — por favor, abra um issue em github.com/nicepkg/nastech/issues se você atingir este limite.',
    ...
    server: {
        ...
        notValidHappyServer: 'Não é um servidor NasTech válido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID da sessão NasTech copiado para a área de transferência',
        failedToCopySessionId: 'Falha ao copiar ID da sessão NasTech',
        happySessionId: 'ID da sessão NasTech',
        ...
        updateCliInstructions: 'Por favor execute npm install -g nastech@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale o NasTech CLI',
            runIt: 'Execute',
