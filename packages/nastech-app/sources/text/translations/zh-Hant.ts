...
export const zhHant: TranslationStructure = {
    ...
    errors: {
        ...
        voiceConversationLimitReached: '您本月已達到語音對話的最大次數。我們未來可能會新增按需語音使用功能——如果您遇到此限制，請在 github.com/nicepkg/nastech/issues 提交 issue。',
    ...
    server: {
        ...
        notValidHappyServer: '不是有效的 NasTech 伺服器',
        changeServer: '更改伺服器',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'NasTech 工作階段 ID 已複製到剪貼簿',
        failedToCopySessionId: '複製 NasTech 工作階段 ID 失敗',
        happySessionId: 'NasTech 工作階段 ID',
        ...
        updateCliInstructions: '請執行 npm install -g nastech@latest',
    ...
    machine: {
        ...
        offlineHelp: '• 確保您的電腦在線上\n• 執行 `nastech daemon status` 進行診斷\n• 您是否在執行最新的 CLI 版本？請使用 `npm install -g nastech@latest` 升級',
        daemon: '守護程序',
        status: '狀態',
        stopDaemon: '停止守護程序',
