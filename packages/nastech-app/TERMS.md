...
NasTech is licensed under the MIT License. This means you are free to:
...
NasTech may connect to third-party AI services (such as Claude, OpenAI, etc.). You acknowledge that:
...
NasTech respects your privacy. The app:
...
These Terms of Use constitute the entire agreement between you and the NasTech project regarding the use of the software, superseding any prior agreements or understandings.