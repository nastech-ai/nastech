...
`@nastech-ai/nastech-wire` centralizes definitions for:
...
In this repository, consumer workspaces import `@nastech-ai/nastech-wire` through package exports that point at `dist/*`.

That means on a clean checkout:
1. Build wire first: `yarn workspace @nastech-ai/nastech-wire build`
...
yarn workspace @nastech-ai/nastech-wire build
yarn workspace @nastech-ai/nastech-wire test
```
