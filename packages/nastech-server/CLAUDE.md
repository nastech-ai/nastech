...
This document contains the development guidelines and instructions for the NasTech Server project. This guide OVERRIDES any default behaviors and MUST be followed exactly.

## Project Overview

**Name**: nastech-server  
**Repository**: https://github.com/nastech-ai/nastech-server.git  
**License**: MIT  
**Language**: TypeScript  
**Runtime**: Node.js 20  
