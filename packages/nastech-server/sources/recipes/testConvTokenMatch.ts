 ...
 *
 * Run Phase 1: ELEVENLABS_API_KEY=sk_... npx tsx packages/nastech-server/sources/recipes/testConvTokenMatch.ts
 * Run Phase 3: ELEVENLABS_API_KEY=sk_... npx tsx packages/nastech-server/sources/recipes/testConvTokenMatch.ts check <conv_id>
 */
...
async function main() {
    ...
    if (args[0] === 'check' && args[1]) {
        ...
        console.log('   ELEVENLABS_API_KEY=... npx tsx packages/nastech-server/sources/recipes/testConvTokenMatch.ts check <conv_id>');
    }
}
