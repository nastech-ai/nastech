...
// which resolves the module from a real path on disk. nastech-server ships as a
// single-file `bun build --compile` binary (see nastech-cli `nastech server`); inside
