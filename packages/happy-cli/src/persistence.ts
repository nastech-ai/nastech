/**
 * Minimal persistence functions for nastech CLI
 * 
 * Handles settings and private key storage in ~/.nastech/ or local .nastech/
 */
  ...
  try {
    ...
    if (schemaVersion > SUPPORTED_SCHEMA_VERSION) {
      logger.warn(
        ...
        'Update nastech-cli for full functionality.'
      );
    }
