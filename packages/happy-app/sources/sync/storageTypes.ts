...
export const MetadataSchema = z.object({
    ...
    happyHomeDir: z.string().optional(), // NasTech configuration directory 
...
export const MachineMetadataSchema = z.object({
    ...
    happyHomeDir: z.string(), // Directory for NasTech auth, settings, logs (usually .nastech/ or .nastech-dev/)
    ...
    shutdownSource: z.enum(['nastech-app', 'nastech-cli', 'os-signal', 'unknown']).optional(),
