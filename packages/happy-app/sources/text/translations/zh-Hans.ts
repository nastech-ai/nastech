...
export const zhHans: TranslationStructure = {
    ...
    errors: {
        ...
        voiceConversationLimitReached: '您本月已达到语音对话的最大次数。我们未来可能会添加按需语音使用功能——如果您遇到此限制，请在 github.com/nicepkg/nastech/issues 提交 issue。',
    ...
    server: {
        ...
        notValidHappyServer: '不是有效的 NasTech 服务器',
        changeServer: '更改服务器',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'NasTech 会话 ID 已复制到剪贴板',
        failedToCopySessionId: '复制 NasTech 会话 ID 失败',
        happySessionId: 'NasTech 会话 ID',
        ...
        updateCliInstructions: '请运行 npm install -g nastech@latest',
        deleteSession: '删除会话',
    ...
    machine: {
        ...
        offlineHelp: '• 确保您的计算机在线\n• 运行 `nastech daemon status` 进行诊断\n• 您是否在运行最新的 CLI 版本？请使用 `npm install -g nastech@latest` 升级',
        daemon: '守护进程',
        status: '状态',
        stopDaemon: '停止守护进程',
