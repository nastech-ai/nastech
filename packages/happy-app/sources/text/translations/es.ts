...
export const es: TranslationStructure = {
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Has alcanzado el número máximo de conversaciones de voz este mes. Es posible que en el futuro agreguemos uso de voz bajo demanda — por favor crea un issue en github.com/nicepkg/nastech/issues si alcanzas este límite.',
    ...
    server: {
        ...
        notValidHappyServer: 'No es un servidor NasTech válido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de sesión de NasTech copiado al portapapeles',
        failedToCopySessionId: 'Falló al copiar ID de sesión de NasTech',
        happySessionId: 'ID de sesión de NasTech',
        ...
        happyHome: 'Directorio de NasTech',
        ...
        updateCliInstructions: 'Por favor ejecute npm install -g nastech@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale el NasTech CLI',
            runIt: 'Ejecútelo',
