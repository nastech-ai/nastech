...
export const ru: TranslationStructure = {
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Вы достигли максимального количества голосовых разговоров в этом месяце. Возможно, в будущем мы добавим голосовое использование по запросу — пожалуйста, создайте заявку на github.com/nicepkg/nastech/issues, если вы столкнулись с этим ограничением.',
    ...
    server: {
        ...
        notValidHappyServer: 'Это не валидный сервер NasTech',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID сессии NasTech скопирован в буфер обмена',
        failedToCopySessionId: 'Не удалось скопировать ID сессии NasTech',
        happySessionId: 'ID сессии NasTech',
        ...
        resumeSessionNeedsHappyAgent: 'Resume is unavailable on this machine. Run `nastech-agent auth login` to enable it.',
        ...
        happyHome: 'Домашний каталог NasTech',
        ...
        updateCliInstructions: 'Пожалуйста, выполните npm install -g nastech@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Установите NasTech CLI',
            runIt: 'Запустите его',
