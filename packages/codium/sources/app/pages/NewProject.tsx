            ...
            <div className="new-project">
                <div className="new-project__panel">
                    ...
                    <p className="new-project__copy">
                        Codium opens chats and terminals inside a project workspace. Worktree projects create local git worktrees in the NasTech workspace folder; plain projects create lightweight sections in the same folder.
                    </p>
