 ...
 * the NasTech CLI and mobile app.
 * 
 ...
 * These messages are forwarded to the NasTech server and mobile app.
 */
 ...
 * this interface to be usable through the NasTech CLI and mobile app.
 */
