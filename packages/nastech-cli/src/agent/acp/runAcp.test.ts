...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    mockStartNasTechServer: vi.fn(),
    mockProjectPath: vi.fn(() => '/tmp/nastech'),
...
vi.mock('@/claude/utils/startNasTechServer', () => ({
  startNasTechServer: mocks.mockStartNasTechServer,
}));
...
describe('runAcp', () => {
  ...
  beforeEach(() => {
    ...
    mocks.mockStartNasTechServer.mockResolvedValue({
