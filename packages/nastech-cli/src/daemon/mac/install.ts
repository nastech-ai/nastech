/**
 * Installation script for NasTech daemon using macOS LaunchDaemons
 * 
 * NOTE: This installation method is currently NOT USED in favor of auto-starting 
 * the daemon when the user runs the nastech command. 
 * 
 ...
 * 2. We assume users will run nastech frequently (every time they open their laptop)
...
const PLIST_LABEL = 'ai.nastech.ba.daemon';
    ...
    try {
        ...
        const plistContent = trimIdent(`
            ...
            <dict>
                ...
                <string>${os.homedir()}/.nastech/daemon.err</string>
                
                <key>StandardOutPath</key>
                <string>${os.homedir()}/.nastech/daemon.log</string>
        ...
        logger.info('Check logs at ~/.nastech/daemon.log');
