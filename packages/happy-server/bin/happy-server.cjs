...
if (!artifact) {
  console.error('Could not locate the NasTech server package runtime.');
  process.exit(1);
}

const env = { ...process.env };
if (artifact.webappDir && !env.NASTECH_STATIC_DIR) {
  env.NASTECH_STATIC_DIR = artifact.webappDir;
}
